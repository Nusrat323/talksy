...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Handle user going offline when closing tab
    const handleUnload = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-100 transition-all duration-300">
      {/* Header */}
      <div className="flex justify-between items-center bg-white px-4 py-3 border-b shadow-sm">
        {selectedChat ? (
          ...
          <div className="flex justify-between items-center w-full">
            <h1 className="font-bold text-2xl text-teal-600">Talksy</h1>
            {activeTab === "chats" && (
              <button
      ...
      {/* Bottom Nav */}
      <div className="h-16 bg-white border-t flex justify-around items-center shadow-md">
        <button
          onClick={() => {
            setActiveTab("chats");
